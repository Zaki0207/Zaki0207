...
<table>
  <tr>
    <td width="33%" valign="top">
      ...
      <p>Multi-view geometry, camera pose estimation, neural radiance fields, Gaussian splatting, point clouds, and novel-view synthesis.</p>
    </td>
    <td width="33%" valign="top">
...
<p>
  <img src="https://skillicons.dev/icons?i=python,pytorch,cpp,c,opencv,js,ts,nodejs,react,html,css,sqlite,git,linux,docker,blender&perline=8" alt="Technology stack" />
</p>
